...
To fix this issue in Kepler Core however, we had to backport a lot of other
...
Keeping a wallet with 1000 KPL unlocked for 24/7 is definitely not a good idea
...
it should be possible to compile Kepler Core with `--disable-wallet` option now.
...
- [`9ad56fe18`](https://github.com/dashpay/dash/commit/9ad56fe18) Kepler related fixes for per-utxo DB
...
### Network/Sync:
- [`5d58dd90c`](https://github.com/dashpay/dash/commit/5d58dd90c) Make sure to clear setAskFor in Kepler submodules (#1730)
