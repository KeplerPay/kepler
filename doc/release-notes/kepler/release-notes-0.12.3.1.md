...
We introduced a new signature format for Kepler-specific network messages,
...
However this option is only available in so called Lite Mode. In this mode, Kepler specific features are disabled, meaning
...
- introduced in Kepler Core 0.12.3.1: `allowprivatenet`, `bip9params`, `sporkaddr`, `devnet`;
...
mnprivkey during MN setup and NOT the one that controls the 1000 KPL collateral) which should make the process of pairing with
...
We now use a recent masternode list to feed the hardcoded seed nodes list in Kepler Core. This list was previously
...
- [`08033ffe4`](https://github.com/dashpay/dash/commit/08033ffe4) Reject Kepler-specific messages from obsolete peers (#1983)
...
- [`532b9fa3d`](https://github.com/dashpay/dash/commit/532b9fa3d) Use OpenNetworkConnection instead of calling ConnectNode directly in Kepler code (#1857)
...
- [`4ea790377`](https://github.com/dashpay/dash/commit/4ea790377) Keplerify lib names (#2035)
...
- [`c65613350`](https://github.com/dashpay/dash/commit/c65613350) Switch masternode id in Kepler data structures from CTxIn to COutPoint (#1933)
...
- [`a7fa07a30`](https://github.com/dashpay/dash/commit/a7fa07a30) Drop BOOST_FOREACH and use references in loops (const ref where applicable, Kepler code only) (#1899)
...
Kepler Core tree 0.11.x was a fork of Bitcoin Core tree 0.9,
Darkcoin was rebranded to Kepler.
