...
* Update hardcoded [seeds](/contrib/seeds/README.md). TODO: Give example PR for Kepler
...
### Kepler Core maintainers/release engineers, update (commit) version in sources
...
### Build and sign Kepler Core for Linux, Windows, and OS X:
...
- Announce the release:
  ...
  - Release on Kepler forum: https://www.dash.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Keplerpay, ... but this will usually sort out itself
