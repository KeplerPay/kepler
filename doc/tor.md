...
config file):
	...
	HiddenServicePort 12102 127.0.0.1:12102
	HiddenServicePort 12202 127.0.0.1:12202

The directory can be different of course, but (both) port numbers should be equal to
your dashd's P2P listen port (12102 by default).
...
and open port 12102 on your firewall (or use -upnp).
