...
The Kepler Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Kepler Core requires ZeroMQ API version 4.x or
...
using. Keplerd appends an up-counting sequence number to each
