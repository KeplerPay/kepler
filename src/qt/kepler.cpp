...
{
    return QCoreApplication::translate("kepler-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. bitcoin_de.qm (shortcut "de" needs to be defined in kepler.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. bitcoin_de_DE.qm (shortcut "de_DE" needs to be defined in kepler.qrc)
...
void BitcoinApplication::initializeResult(int retval)
{
    ...
    if(retval)
    {
        ...
        // kepler: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(kepler);
    Q_INIT_RESOURCE(kepler_locale);
    ...
    /// 6. Determine availability of data directory and parse kepler.conf
    ...
    // kepler: links repeatedly have their payment requests routed to this process:
