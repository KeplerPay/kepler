...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "kepler",               "masternode",             &masternode,             true,  {} },
    { "kepler",               "masternodelist",         &masternodelist,         true,  {} },
    { "kepler",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "kepler",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "kepler",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "kepler",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
